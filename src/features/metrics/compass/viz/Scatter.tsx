  ...
  return (
    <div className="space-y-2">
      <svg viewBox={`0 0 ${w} ${h}`} className="w-full h-auto">
        ...
        {points.map((p, i) => (
          <circle
            ...
            style={{ animation: `compass-scale-in 0.4s ease-out ${i * 25}ms backwards` }}
          />
        ))}
      ...
      <div className="text-xs text-zinc-500">
        Correlação: <span className="compass-tabular font-medium" style={{ color: 'var(--pillar)' }}>r = {correlation.toFixed(2)}</span>
