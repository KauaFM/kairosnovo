// =============================================================
// ORVAX · NÚCLEO — a forma COMPACTA da Simbiose
//
// A Simbiose de verdade (a massa orgânica, em Simbiose.jsx) é a
// entidade em escala de presença: ela precisa de espaço para a
// matéria se deformar, a poeira sair e o núcleo pulsar. Reduzida a
// 30-60px vira um borrão escuro — testei, e não funciona.
//
// Este é o mesmo ser na forma reduzida: anéis concêntricos, órbita
// e um anel de leitura que varre. Serve onde o espaço é pequeno —
// o atalho no canto, o cabeçalho da conversa, a rubrica do cartão.
// Mantém os nove estados, então a leitura do estado não se perde no
// tamanho pequeno; ao contrário, aqui ela fica MAIS legível, porque
// o traço do anel diz o estado sem depender de movimento.
// =============================================================
...
export default function NucleoOrvax({ estado = 'IDLE', tamanho = 120, className = '', style }) {
