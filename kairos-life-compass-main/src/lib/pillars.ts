export type PillarSlug =
  | "mente" | "saude" | "nutricao" | "financeiro" | "carreira" | "metas"
  | "relacionamentos" | "interno" | "habitos" | "aprendizado" | "lazer" | "identidade";

export type PillarConfig = {
  slug: PillarSlug;
  name: string;
  tagline: string;
  /** Eixos do radar interno (cada eixo é métrica DAQUELE pilar) */
  axes: { key: string; label: string; inverted?: boolean }[];
  /** Categorias para Execution Map e Sankey */
  activities: { key: string; label: string; type: "produtivo" | "distracao" | "neutro" }[];
  /** Texto de impacto */
  impacts: string[];
  /** Habito chave + prioridade */
  keyHabit: string;
  priority: string;
  /** Eixos para scatter plot (correlação) */
  correlation: { x: string; y: string; label: string };
};

export const PILLARS: PillarConfig[] = [
  {
    slug: "mente", name: "Mente", tagline: "Foco, clareza e energia cognitiva",
    axes: [
      { key: "foco", label: "Foco" },
  ...
  {
    slug: "saude", name: "Saúde", tagline: "Corpo, sono e vitalidade",
    axes: [
  ...
  {
    slug: "nutricao", name: "Nutrição", tagline: "Combustível e composição",
    axes: [
  ...
  {
    slug: "financeiro", name: "Financeiro", tagline: "Fluxo, reserva e direção",
    axes: [
  ...
  {
    slug: "carreira", name: "Carreira", tagline: "Skill, output e reputação",
    axes: [
  ...
  {
    slug: "metas", name: "Metas", tagline: "Norte e progresso",
    axes: [
  ...
  {
    slug: "relacionamentos", name: "Relacionamentos", tagline: "Vínculos e presença",
    axes: [
  ...
  {
    slug: "interno", name: "Interno", tagline: "Emoção, sentido, paz",
    axes: [
  ...
  {
    slug: "habitos", name: "Hábitos", tagline: "Sistema operacional do dia",
    axes: [
  ...
  {
    slug: "aprendizado", name: "Aprendizado", tagline: "Skill compounding",
    axes: [
  ...
  {
    slug: "lazer", name: "Lazer", tagline: "Recarga real, não fuga",
    axes: [
  ...
  {
    slug: "identidade", name: "Identidade", tagline: "Quem você está se tornando",
    axes: [
...
export const getPillar = (slug: string): PillarConfig | undefined =>
